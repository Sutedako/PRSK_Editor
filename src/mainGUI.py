...
class Ui_SekaiText(object):
    def setupUi(self, SekaiText):
        ...
        self.pushButtonCreate.setMinimumSize(QtCore.QSize(100, 30))
        self.pushButtonCreate.setMaximumSize(QtCore.QSize(100, 30))
    ...
    def retranslateUi(self, SekaiText):
        ...
        self.pushButtonCreate.setText(_translate("SekaiText", u"重头开始"))
