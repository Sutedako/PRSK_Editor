...
class Ui_SekaiText(object):
    def setupUi(self, SekaiText):
        ...
        self.comboBoxStoryIndex.setMinimumSize(QtCore.QSize(360, 30))
        ...
        self.comboBoxStoryChapter.setMinimumSize(QtCore.QSize(200, 30))
    ...
    def retranslateUi(self, SekaiText):
        ...
        self.comboBoxStoryType.setItemText(3, _translate("SekaiText", u"初始卡面"))
