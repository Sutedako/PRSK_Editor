...
class Ui_SekaiText(object):
    def setupUi(self, SekaiText):
        ...
        self.radioButtonJudge = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonJudge.setMinimumSize(QtCore.QSize(92, 30))
        self.radioButtonJudge.setMaximumSize(QtCore.QSize(92, 30))
        self.radioButtonJudge.setObjectName("radioButtonJudge")
        self.horizontalLayout_3.addWidget(self.radioButtonJudge)

        self.pushButtonSave = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonSave.setMinimumSize(QtCore.QSize(60, 30))
        self.pushButtonSave.setMaximumSize(QtCore.QSize(60, 30))
        ...
        self.labelDataSrc.setMinimumSize(QtCore.QSize(80, 30))
        self.labelDataSrc.setMaximumSize(QtCore.QSize(80, 30))
        ...
        self.comboBoxDataSource.setMinimumSize(QtCore.QSize(230, 30))
        ...
        self.pushButtonCreate.setMinimumSize(QtCore.QSize(60, 30))
        self.pushButtonCreate.setMaximumSize(QtCore.QSize(60, 30))
        self.pushButtonCreate.setObjectName("pushButton")
        ...
        self.plainTextEditTitle.setMinimumSize(QtCore.QSize(260, 30))
        self.plainTextEditTitle.setMaximumSize(QtCore.QSize(260, 30))
        ...
        self.pushButtonOpen.setMinimumSize(QtCore.QSize(60, 30))
        self.pushButtonOpen.setMaximumSize(QtCore.QSize(60, 30))
        ...
        self.checkBoxShowDiff.setMinimumSize(QtCore.QSize(160, 30))
        self.checkBoxShowDiff.setMaximumSize(QtCore.QSize(160, 30))
        self.checkBoxShowDiff.setObjectName("checkBoxShowDiff")
        self.horizontalLayout_4.addWidget(self.checkBoxShowDiff)
        ...
        self.tableWidgetSrc.setMinimumSize(QtCore.QSize(760, 500))
        ...
        self.tableWidgetDst.setMinimumSize(QtCore.QSize(700, 500))
    ...
    def retranslateUi(self, SekaiText):
        ...
        self.comboBoxStoryType.setItemText(2, _translate("SekaiText", u"卡牌剧情"))
        self.comboBoxStoryType.setCurrentText(_translate("SekaiText", u"活动剧情"))
        self.pushButtonRefresh.setText(_translate("SekaiText", u"刷新"))
        ...
        self.radioButtonJudge.setText(_translate("SekaiText", u"审核"))
        ...
        self.comboBoxDataSource.setItemText(0, _translate("SekaiText", u"sekai.best(暂不支持)"))
        self.comboBoxDataSource.setItemText(1, _translate("SekaiText", u"pjsek.ai"))
        self.comboBoxDataSource.setItemText(2, _translate("SekaiText", u"本地文件"))
        self.comboBoxDataSource.setCurrentText(_translate("SekaiText", u"本地文件"))
        self.pushButtonLoad.setText(_translate("SekaiText", u"载入"))
        self.pushButtonCreate.setText(_translate("SekaiText", u"生成"))
