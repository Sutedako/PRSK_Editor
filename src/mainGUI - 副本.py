...
class Ui_SekaiText(object):
    def setupUi(self, SekaiText):
        SekaiText.setObjectName("SekaiText")
        SekaiText.resize(889, 660)
        ...
        self.comboBoxStoryType.setMinimumSize(QtCore.QSize(110, 30))
        self.comboBoxStoryType.setMaximumSize(QtCore.QSize(110, 30))
        ...
        self.comboBoxStoryIndex.setMinimumSize(QtCore.QSize(200, 30))
        self.comboBoxStoryIndex.setMaximumSize(QtCore.QSize(200, 30))
        ...
        self.comboBoxStoryChapter.setMinimumSize(QtCore.QSize(60, 30))
        self.comboBoxStoryChapter.setMaximumSize(QtCore.QSize(60, 30))
        ...
        self.pushButtonRefresh.setMinimumSize(QtCore.QSize(60, 30))
        self.pushButtonRefresh.setMaximumSize(QtCore.QSize(60, 30))
        ...
        self.radioButtonTranslate.setMinimumSize(QtCore.QSize(70, 30))
        self.radioButtonTranslate.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.radioButtonProofread.setMinimumSize(QtCore.QSize(70, 30))
        self.radioButtonProofread.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.radioButtonCheck.setMinimumSize(QtCore.QSize(70, 30))
        self.radioButtonCheck.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.pushButtonCheck_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonCheck_2.setMinimumSize(QtCore.QSize(80, 30))
        self.pushButtonCheck_2.setMaximumSize(QtCore.QSize(80, 30))
        self.pushButtonCheck_2.setObjectName("pushButtonCheck_2")
        self.horizontalLayout_3.addWidget(self.pushButtonCheck_2)
        self.gridLayout.addLayout(self.horizontalLayout_3, 0, 1, 1, 1)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.labelDataSrc = QtWidgets.QLabel(self.centralwidget)
        self.labelDataSrc.setMinimumSize(QtCore.QSize(100, 30))
        self.labelDataSrc.setMaximumSize(QtCore.QSize(100, 30))
        ...
        self.comboBoxDataSource.setMinimumSize(QtCore.QSize(280, 30))
        self.comboBoxDataSource.setMaximumSize(QtCore.QSize(280, 30))
        ...
        self.pushButtonLoad.setMinimumSize(QtCore.QSize(60, 30))
        self.pushButtonLoad.setMaximumSize(QtCore.QSize(60, 30))
        ...
        self.labelTitle.setMinimumSize(QtCore.QSize(60, 30))
        self.labelTitle.setMaximumSize(QtCore.QSize(60, 30))
        self.labelTitle.setObjectName("labelTitle")
        self.horizontalLayout_4.addWidget(self.labelTitle)
        self.plainTextEditTitle = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.plainTextEditTitle.setMinimumSize(QtCore.QSize(300, 30))
        self.plainTextEditTitle.setMaximumSize(QtCore.QSize(300, 30))
        self.plainTextEditTitle.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.plainTextEditTitle.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.plainTextEditTitle.setObjectName("plainTextEditTitle")
        self.horizontalLayout_4.addWidget(self.plainTextEditTitle)
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setText("")
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_4.addWidget(self.label_4)
        self.pushButtonCheck = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonCheck.setMinimumSize(QtCore.QSize(80, 30))
        self.pushButtonCheck.setMaximumSize(QtCore.QSize(80, 30))
        ...
        self.tableWidgetSrc.setMinimumSize(QtCore.QSize(0, 500))
        self.tableWidgetSrc.setMaximumSize(QtCore.QSize(500, 16777215))
        ...
        self.tableWidgetSrc.horizontalHeader().resizeSection(0, 100)
        ...
        self.tableWidgetDst.horizontalHeader().resizeSection(3, 50)
        ...
        self.toolBar = QtWidgets.QToolBar(SekaiText)
        self.toolBar.setObjectName("toolBar")
        SekaiText.addToolBar(QtCore.Qt.TopToolBarArea, self.toolBar)
    ...
    def retranslateUi(self, SekaiText):
        ...
        self.comboBoxStoryType.setItemText(0, _translate("SekaiText", "主线剧情"))
        self.comboBoxStoryType.setItemText(1, _translate("SekaiText", "活动剧情"))
        self.comboBoxStoryType.setItemText(2, _translate("SekaiText", "卡牌剧情"))
        self.comboBoxStoryType.setCurrentText(_translate("SekaiText", "活动剧情"))
        self.pushButtonRefresh.setText(_translate("SekaiText", "刷新"))
        self.radioButtonTranslate.setText(_translate("SekaiText", "翻译"))
        self.radioButtonProofread.setText(_translate("SekaiText", "校对"))
        self.radioButtonCheck.setText(_translate("SekaiText", "合意"))
        self.pushButtonCheck_2.setText(_translate("SekaiText", "名词表"))
        self.labelDataSrc.setText(_translate("SekaiText", "数据来源："))
        self.comboBoxDataSource.setItemText(0, _translate("SekaiText", "sekai.best"))
        self.comboBoxDataSource.setItemText(1, _translate("SekaiText", "pjsek.ai"))
        self.comboBoxDataSource.setItemText(2, _translate("SekaiText", "本地文件"))
        self.pushButtonLoad.setText(_translate("SekaiText", "载入"))
        self.labelTitle.setText(_translate("SekaiText", "标题："))
        self.pushButtonCheck.setText(_translate("SekaiText", "检查"))
        item = self.tableWidgetDst.horizontalHeaderItem(0)
        item.setText(_translate("SekaiText", "行号"))
        item = self.tableWidgetDst.horizontalHeaderItem(1)
        item.setText(_translate("SekaiText", "说话人"))
        item = self.tableWidgetDst.horizontalHeaderItem(2)
        item.setText(_translate("SekaiText", "内容文本"))
        item = self.tableWidgetDst.horizontalHeaderItem(3)
        item.setText(_translate("SekaiText", "换行"))
        ...
        self.toolBar.setWindowTitle(_translate("SekaiText", "toolBar"))
